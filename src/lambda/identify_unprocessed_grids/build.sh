#!/bin/bash
pip install -t . pip==21.1.3
python -m pip install --upgrade -t . msal==1.6.0 python-json-logger==2.0.1 requests==2.25.0
...
rm -rf master.zip product-catalogue-master pip*